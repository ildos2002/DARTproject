...
import 'package:mynotesapplication/widgets/delete_popup.dart';
...
@override
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      actions: [
        ...
        IconButton(icon: Icon(Icons.insert_photo),
        color: Colors.black,
        onPressed: (){
        ...
        child: Column(
          children: [
            ...
            child: TextField(
              ...
              style: createTitle,
              decoration: InputDecoration(hintText: 'Введите заголовок', border: InputBorder.none),
            ),
            ),
            if(_image != null)
              Container(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          titleController.text = 'Без названия';
          saveNote();
        },
  ...
  void saveNote() {
    ...
    if(id != null){
      Provider.of<NoteProvider>(this.context, listen: false,).addOrUpdateNote(id, title, content, imagePath, EditMode.UPDATE);
